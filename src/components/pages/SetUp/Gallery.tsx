...
<div className="gradient-background min-h-screen w-screen flex items-center justify-center py-[2%] px-[5%] xl:px-[10%] h-full">
      ...
      >
        ...
        <div className="flex flex-col w-full lg:w-[30%] min-w-[300px] max-w-full mx-auto z-20 ">
          ...
          <div className="flex items-center justify-center gap-[3%] mb-[5%]">
            ...
            <h1 className=" items-center justify-center text-center text-3xl md:text-4xl font-bold text-[#EAB308]">Gallery</h1>
          </div>
          ...
          <div className="form-container lg:h-[90%]">
            <div className="space-y-[1%] p-[1%]">
              {/* Title Input */}
              <div >                      
                <label htmlFor="title" className="form-label">Gallery Name</label>
                <textarea
                  id="title"
                  value={title}
      ...
      <div className="grid grid-cols-4 gap-4 mb-8 w-full max-w-screen-md">
        {images.map((img, index) => (
          <div
            key={index}
            className="custom-box-dotted relative w-full h-20  flex items-center justify-center  overflow-hidden"
          >
            <img
              src={img}
        ...
        <label
          htmlFor="file-upload"
          className="custom-box-dotted w-full h-20  flex items-center justify-center text-[#EAB308] transition"
        >
          +
          <input
            type="file"
                  ...
                  >
                    {logo ? (
                      ...
                      <>
                        ...
                        <span className="text-center">Add more Photos</span>
                      </>
                    )}
                  </label>
                </div>
